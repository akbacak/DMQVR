function varargout = DMQVR_v2_3d(varargin)
% DMQVR_V2_3D MATLAB code for DMQVR_v2_3d.fig
%      DMQVR_V2_3D, by itself, creates a new DMQVR_V2_3D or raises the existing
%      singleton*.
%
%      H = DMQVR_V2_3D returns the handle to a new DMQVR_V2_3D or the handle to
%      the existing singleton*.
%
%      DMQVR_V2_3D('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DMQVR_V2_3D.M with the given input arguments.
%
%      DMQVR_V2_3D('Property','Value',...) creates a new DMQVR_V2_3D or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DMQVR_v2_3d_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DMQVR_v2_3d_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DMQVR_v2_3d

% Last Modified by GUIDE v2.5 16-May-2019 10:41:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DMQVR_v2_3d_OpeningFcn, ...
                   'gui_OutputFcn',  @DMQVR_v2_3d_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DMQVR_v2_3d is made visible.
function DMQVR_v2_3d_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DMQVR_v2_3d (see VARARGIN)

% Choose default command line output for DMQVR_v2_3d
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DMQVR_v2_3d wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DMQVR_v2_3d_OutputFcn(hObject, eventdata, handles) 
...
switch hashCode_index
    ...
    case 1
        ...
        %data = features_128 > 0.5;
            ...
            mov_3=VideoReader('Python/q3.mp4');
            nFrames_3=mov_3.NumberOfFrames;
            for i=1:nFrames_3
                videoFrame_3=read(mov_3,i);
                axes(handles.axes37);
                imshow(videoFrame_3);  axis image;
            end
