...
json_file = open('/home/ubuntu/keras/enver/dmlvh2/models/dmlvh2_mLSTM_128_model.json', 'r')
model = json_file.read()
json_file.close()
model = model_from_json(model)
model.load_weights("/home/ubuntu/keras/enver/dmlvh2/models/dmlvh2_mLSTM_128_weights.h5")
