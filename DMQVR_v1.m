function varargout = DMQVR_v1(varargin)
% DMQVR_v1 MATLAB code for DMQVR_v1.fig
%      DMQVR_v1, by itself, creates a new DMQVR_v1 or raises the existing
%      singleton*.
%
%      H = DMQVR_v1 returns the handle to a new DMQVR_v1 or the handle to
%      the existing singleton*.
%
%      DMQVR_v1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DMQVR_v1.M with the given input arguments.
%
%      DMQVR_v1('Property','Value',...) creates a new DMQVR_v1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DMQVR_v1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DMQVR_v1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DMQVR_v1

% Last Modified by GUIDE v2.5 22-May-2019 01:04:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DMQVR_v1_OpeningFcn, ...
                   'gui_OutputFcn',  @DMQVR_v1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DMQVR_v1 is made visible.
function DMQVR_v1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DMQVR_v1 (see VARARGIN)

% Choose default command line output for DMQVR_v1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DMQVR_v1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DMQVR_v1_OutputFcn(hObject, eventdata, handles) 
